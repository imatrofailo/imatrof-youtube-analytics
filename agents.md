...
Before starting new work, read the patterns/architecture in the owner's private `imatrofailo/imatrof-docs` repo; if you don't have access or a clone, ask the owner. This file covers only this repository.
